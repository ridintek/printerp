...
$autoload['libraries'] = array('session', 'database', 'parser', 'sma', 'ridintek', 'XSession');
...
$autoload['model'] = [
  'app', 'site', 'Adjustment', 'Attachment', 'Bank', 'Biller',
  'Category', 'CronModel', 'Customer',
  'DB', 'Expense',
  'GoogleReview', 'InternalUse', 'MaintenanceLog',
  'OrderRef',
