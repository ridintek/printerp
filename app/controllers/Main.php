...
class Main extends MY_Controller // From MY_Shop_Controller
{
  public function __construct()
  {
    ...
    $this->lang->admin_load('auth', $this->Settings->language);
  ...
  public function forgot_password()
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      if ($forgotten) {
        sendJSON(['status' => 'success', 'message' => $this->ion_auth->messages()]);
      } else {
        sendJSON(['status' => 'error', 'message' => $this->ion_auth->errors()]);
      }
    }
  }
