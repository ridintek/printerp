      ...
      if ($q->num_rows() > 0) {
        ...
        foreach ($rows as $sale) {
          ...
          foreach ($sale_items as $item) {
            ...
            $excel->setCellValue('G' . $b, ($item->status != 'need_payment' && $item->status != 'draft' ? $timeleft : ''));
            $excel->setCellValue('H' . $b, ($item->status != 'need_payment' && $item->status != 'draft' ? $overdue : ''));
            ...
            $excel->setCellValue('S' . $b, lang($item->status));
