...
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_raw_material_csv'); ?></h2>
  </div>
  <div class="box-content">
    <div class="row">
      <div class="col-lg-12">
        ...
        <?php
        $attrib = ['class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form', 'id' => 'csv-uploader'];
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="well well-small">
              <a href="#"
                class="btn btn-primary pull-right"><i class="fa fa-download"></i> <?= lang('download_sample_file') ?>
              </a>
              <p>
                <span class="text-warning"><?= lang('csv1'); ?></span><br/><?= lang('csv2'); ?> <span
                class="text-info"></span> <?= lang('csv3'); ?>
              </p>
