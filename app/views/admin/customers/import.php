...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title text-center" id="myModalLabel"><?php echo lang('add_customers_csv'); ?></h4>
    </div>
    <?php $attrib = ['data-toggle' => 'validator', 'role' => 'form'];
    echo admin_form_open_multipart('customers/import', $attrib); ?>
    <div class="modal-body">
      <div class="well well-small">
        <a href="https://docs.google.com/spreadsheets/d/10TTGIcGUq6Xxi4H-l1XsfbpzF_v08ajjtwClDZbMGX0/edit?usp=sharing"
    ...
    <div class="modal-footer">
      ...
      <button class="btn btn-primary" type="submit"><i class="fad fa-fw fa-upload"></i> <?= lang('import'); ?></button>
    </div>
    <?php echo form_close(); ?>
  </div>
</div>
