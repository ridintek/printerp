...
<div class="modal-content">
  ...
  <div class="modal-body">
    ...
    <img src="<?= admin_url('gallery/attachment/' . $attachment->id); ?>" style="width: 100%;" />
    <?php } else if ($mime_type == 'application/pdf') { ?>
    <embed src="<?= admin_url('gallery/attachment/' . $attachment->id); ?>" height="540" width="1024" />
    <?php } else if ($mime_type != '') { ?>
    <div>Unknown file type (<?= $mime_type; ?>).
      Please download <a href="<?= admin_url('gallery/attachment/' . $attachment->id . '&d=1'); ?>" target="_blank">HERE</a></div>
    <?php } else { ?>
