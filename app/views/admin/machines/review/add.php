...
<div class="modal-content">
  <div class="modal-header">
    ...
    <h4 class="modal-title text-center" id="myModalLabel">Add Review [<?= $product->code ?>]</h4>
  </div>
...
<script>
  $(document).ready(function() {
    let pic = <?= !empty($maintenanceLog) ? $maintenanceLog->pic_id : 0 ?>;
    ...
    $('#submit').click(function() {
      ...
      $.ajax({
        ...
        url: site.base_url + 'machines/review/add/<?= $product->id ?>'
      });
    });
  });
</script>