...
<div class="modal-content">
  <div class="modal-header">
    ...
    <h4 class="modal-title text-center" id="myModalLabel">View Product Review [<?= $product->code ?>]</h4>
  </div>
  ...
  $(document).ready(function () {
    ...
    window.Table2 = $('#ReportTable').DataTable({
      ajax: {
        ...
        method: 'POST',
        url: site.base_url + 'machines/review/getReviews?product_id=<?= $product->id ?><?= $q ?>'
      },
      columnDefs: [{
          targets: 0,
          orderable: false
