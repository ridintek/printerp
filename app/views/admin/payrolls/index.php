...
<script>
  $(document).ready(function () {
    oTable = $('#Table').dataTable({
      ...
      'sAjaxSource': '<?= admin_url('payrolls/getPayrolls') ?>',
      ...
      "aoColumns": [
        {"bSortable": false, "mRender": checkbox}, null, null, null, null, null,
        {"mRender": renderStatus}, {"bSortable": false, "mRender": notes},
        {"bSortable": false}]
    });
  });
</script>
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fad fa-book"></i> Payrolls</h2>
    <div class="box-icon">
      <ul class="btn-tasks">
        <li class="dropdown">
