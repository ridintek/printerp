          ...
          ?>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $purchase->warehouse_id), 'id="powarehouse" class="select2" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('warehouse') . '" required="required" disabled="disabled" style="width:100%;" ');
                ?>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                echo form_dropdown('status', $post, (isset($_POST['status']) ? $_POST['status'] : $purchase->status), 'id="postatus" class="select2" data-placeholder="' . $this->lang->line('select') . ' ' . $this->lang->line('status') . '" required="required" style="width:100%;" ');
                ?>
              </div>
            </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      $tr[''] = '';
                        ...
                        echo form_dropdown('order_tax', $tr, '', 'id="potax2" class="select2" style="width:100%;"'); ?>
                    </div>
                  </div>
                <?php
                      } ?>
          ...
          <div class="col-md-6 col-sm-6">
            ...
            <?php if ($Settings->tax1) {
              ...
              <div class="form-group">
                ...
                echo form_dropdown('mtax', $tr, '', 'id="mtax" class="select2" style="width:100%;"'); ?>
              </div>
              <div class="form-group all">
                <?= lang('tax_method', 'mtax_method') ?>
                <?php
                $tm = ['0' => lang('inclusive'), '1' => lang('exclusive')];
                echo form_dropdown('tax_method', $tm, '', 'class="select2" id="mtax_method" placeholder="' . lang('select') . ' ' . lang('tax_method') . '" style="width:100%"')
                ?>
              </div>
            <?php
              } ?>
