...
<script>
  $(document).ready(function() {
    ...
    window.Table = $('#PurchaseTable').DataTable({
      ajax: {
        data: function(data) {
          data[security.csrf_token_name] = security.csrf_hash;
        },
        method: 'POST',
        url: site.base_url + 'procurements/purchases2/getPurchases?<?= $q ?>'
      },
      columnDefs: [{
          targets: 0,
          orderable: false,
      ...
      <ul class="btn-tasks">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right tasks-menus" role="menu" aria-labelledby="dLabel">
            <li>
              <a href="<?= admin_url('procurements/purchases2/add'); ?>" id="add_purchase" data-toggle="modal" data-backdrop="false" data-target="#myModal" data-modal-class="modal-lg">
                <i class="fad fa-fw fa-plus-square"></i> Add Purchase
              </a>
            </li>
            <li class="divider"></li>
            <li>
              <a href="#" id="batchDelete">
                <i class="fad fa-fw fa-trash"></i> Delete Purchase
              </a>
            </li>
          </ul>
        </li>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div id="form_filter" class="closed well well-sm" style="display: none">
          <?php echo admin_form_open('procurements/purchases2'); ?>
          <div class="row">
            <div class="col-sm-4">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <a href="<?= admin_url('procurements/purchases2'); ?>" class="btn btn-danger">Reset</a>
              </div>
            </div>
          </div>
          <?php echo form_close(); ?>
        ...
        <table id="PurchaseTable" class="table table-bordered table-condensed table-hover table-striped" cellpadding="0" cellspacing="0" borders="0" style="width:100%">
          <thead>
            <tr>
...
<script>
  $(document).ready(function() {
    $('#batchDelete').click(function() {
      addConfirm({
        message: 'Hapus Purchase yang terpilih?',
        ...
        onok: () => {
          ...
          $.ajax({
            ...
            url: site.base_url + 'procurements/purchases2/delete'
          })
        }
      });
    });
    ...
    $('#btn_filter').click(function() {
      ...
      location.href = site.base_url + 'procurements/purchases2' + q;
    });
  });
</script>