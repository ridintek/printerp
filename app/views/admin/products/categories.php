...
<script>
  $(document).ready(function () {
    oTable = $('#Table').dataTable({
      ...
      'sAjaxSource': '<?= admin_url('products/getCategories') ?>',
...
<?= admin_form_open('products/category_actions', 'id="action-form"') ?>
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fa-fw fad fa-folder-open"></i><?= lang('product_categories'); ?></h2>
      ...
      <ul class="btn-tasks">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
            <li>
              <a href="<?php echo admin_url('products/add_category'); ?>" data-toggle="modal" data-target="#myModal">
                <i class="fad fa-fw fa-plus"></i> <?= lang('add_category') ?>
              </a>
            </li>
            <li>
              <a href="<?php echo admin_url('products/import_categories'); ?>" data-toggle="modal" data-target="#myModal">
                <i class="fad fa-fw fa-plus"></i> <?= lang('add_categories_csv') ?>
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#" id="delete" data-action="delete">
                <i class="fad fa-fw fa-trash"></i> <?= lang('delete_categories') ?>
              </a>
            </li>
          </ul>
        </li>
