        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="well well-small">
              <a href="<?php echo base_url(); ?>assets/csv/sample_raw_materials.csv"
                 class="btn btn-primary pull-right"><i
                  class="fa fa-download"></i> <?= lang('download_sample_file') ?></a>
              <p>
                <span class="text-warning"><?= lang('csv1'); ?></span><br/><?= lang('csv2'); ?> <span
                class="text-info">(<?= lang('name') . ', ' . lang('code') . ', ' . lang('unit_code') . ', ' . lang('category_code') . ', ' . lang('cost') . ', ' . lang('price') . ', ' . lang('mark_on') . ', ' . lang('alert_quantity') ?>
                )</span> <?= lang('csv3'); ?>
              </p>
