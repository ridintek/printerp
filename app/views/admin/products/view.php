          ...
          <ul class="btn-tasks">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                ...
                <li class="divider"></li>
                <li>
                  <a href="#" class="bpo" title="<?= lang('delete_product') ?>" data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= admin_url('products/delete/' . $product->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>" data-html="true" data-placement="left">
          ...
          <div class="col-lg-12">
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="row">
                  <div class="col-sm-5">
                    <?php if (($Owner || $Admin || getPermission('products-std_qty')) && $product->type == 'standard') {
                    ?>
                          ...
                          <tbody>
                            <?php foreach ($warehouses as $warehouse) { ?>
                              ...
                              <tr>
                                ...
                                <td class="text-right"><strong><?= $this->sma->formatQuantity($warehouse->quantity, 2); ?></strong></td>
                              </tr>
                            <?php } ?>
                          </tbody>
                        </table>
            ...
            <?php if (!$Supplier || !$Customer) { ?>
              <div class="buttons">
                <div class="btn-group btn-group-justified">
                  ...
                  <div class="btn-group">
                    <a href="#" class="tip btn btn-danger bpo" title="<?= lang('delete_product') ?>" data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= admin_url('products/delete/' . $product->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>" data-html="true" data-placement="top">
              ...
              <div class="row" style="margin-bottom: 15px;">
                ...
                ?>
                  <div class="col-sm-6">
                    <div class="box" style="border-top: 1px solid #dbdee0;">
                      <div class="box-header">
                        <h2 class="blue"><i class="fa-fw fa fa-chart-bar"></i><?= lang('purchased'); ?></h2>
                      </div>
                      <div class="box-content">
                        <div class="row">
                          <div class="col-md-12">
    ...
    <div id="transfers" class="tab-pane fade">
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="box-icon">
            <ul class="btn-tasks">
              <li class="dropdown"><a href="#" id="pdf3" class="tip" title="<?= lang('download_pdf') ?>"><i class="icon fa fa-file-pdf"></i></a></li>
              <li class="dropdown"><a href="#" id="xls3" class="tip" title="<?= lang('download_xls') ?>"><i class="icon fa fa-file-excel"></i></a></li>
              <li class="dropdown"><a href="#" id="image3" class="tip image" title="<?= lang('save_image') ?>"><i class="icon fa fa-file-image"></i></a></li>
            </ul>
          </div>
        </div>
        <div class="box-content">
