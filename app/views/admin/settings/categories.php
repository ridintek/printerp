...
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('product_categories'); ?></h2>
      ...
      <ul class="btn-tasks">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
            ...
            <li>
              <a href="<?php echo admin_url('system_settings/import_product_categories'); ?>" data-toggle="modal" data-target="#myModal">
                <i class="fa fa-plus"></i> <?= lang('add_categories_csv') ?>
              </a>
            </li>
            <li>
