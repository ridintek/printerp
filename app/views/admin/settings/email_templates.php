        ...
        <div class="row">
          <div class="col-md-8 col-sm-8">
            <ul id="myTab" class="nav nav-tabs">
              ...
              <li class="dropdown">
                ...
                <ul aria-labelledby="more" role="menu" class="dropdown-menu">
                  ...
                  <li class=""><a href="#sale_status"><?= lang('sale_status') ?></a></li>
            ...
            <div class="tab-content">
              ...
              <div id="sale_status" class="tab-pane fade">
                <?= admin_form_open('system_settings/email_templates/sale_status'); ?>

                <?php echo form_textarea('mail_body', (isset($_POST['mail_body']) ? html_entity_decode($_POST['mail_body']) : html_entity_decode($sale_status)), 'class="form-control" id="comment"'); ?>
