...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title text-center" id="myModalLabel"><?php echo lang('add_warehouses_csv'); ?></h4>
    </div>
    <?php $attrib = ['data-toggle' => 'validator', 'role' => 'form'];
    echo admin_form_open_multipart('system_settings/import_warehouses', $attrib); ?>
    <div class="modal-body">
      <div class="well well-small">
        <a href="https://docs.google.com/spreadsheets/d/1phfpIb70ltxKjEpMNVq2pc_-PDOLWH3GfVSISe8OoLY/edit?usp=sharing"
