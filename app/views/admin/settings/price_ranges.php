...
<script>
	$(document).ready(function () {
		oTable = $('#CGData').dataTable({
			...
			'sAjaxSource': '<?= admin_url('system_settings/getPriceRanges') ?>',
...
<?= admin_form_open('system_settings/price_ranges_actions', 'id="action-form"') ?>
<div class="box">
  <div class="box-header">
    ...
    <div class="box-icon">
      <ul class="btn-tasks">
        <li class="dropdown">
          <a title="<?= lang('Add Price Range') ?>" class="tip" href="<?php echo admin_url('system_settings/add_price_range'); ?>" data-toggle="modal" data-target="#myModal">
