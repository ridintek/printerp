          ...
          <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
            <li>
              <a href="<?php echo admin_url('system_settings/add_unit'); ?>" data-toggle="modal" data-target="#myModal">
                <i class="fa fa-fw fa-plus"></i> <?= lang('add_unit') ?>
              </a>
            </li>
            <li><a href="<?= admin_url('system_settings/import_units'); ?>" id="import" data-toggle="modal" data-backdrop="false" data-target="#myModal"><i class="fa fa-fw fa-upload"></i> <?= lang('add_units_csv') ?></a></li>
            <li>
              <a href="#" id="excel" data-action="export_excel">
                <i class="fa fa-fw fa-file-excel-o"></i> <?= lang('export_to_excel') ?>
              </a>
            </li>
            <li class="divider"></li>
            <li>
              <a href="#" id="delete" data-action="delete">
                <i class="fa fa-fw fa-trash-o"></i> <?= lang('delete_units') ?>
              </a>
            </li>
          </ul>
        </li>
