...
<div class="box">
  <div class="box-header">
    <h2 class="blue"><i class="fad fa-fw fa-warehouse"></i><?= $page_title ?></h2>
          ...
          <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
            <li>
              <a href="<?php echo admin_url('system_settings/add_warehouse'); ?>" data-toggle="modal" data-target="#myModal">
                <i class="fad fa-fw fa-plus"></i> <?= lang('add_warehouse') ?>
              </a>
            </li>
            <li><a href="<?= admin_url('system_settings/import_warehouses'); ?>" id="import" data-toggle="modal" data-backdrop="false" data-target="#myModal"><i class="fad fa-fw fa-upload"></i> <?= lang('add_warehouses_csv') ?></a></li>
            <li>
            ...
            <li>
              <a href="#" id="delete" data-action="delete">
                <i class="fad fa-fw fa-trash"></i> <?= lang('delete_warehouses') ?>
              </a>
            </li>
