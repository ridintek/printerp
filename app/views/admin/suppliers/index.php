      ...
      <ul class="btn-tasks">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-right tasks-menus" role="menu" aria-labelledby="dLabel">
            ...
            <li>
              <a href="<?= admin_url('suppliers/import'); ?>" data-toggle="modal" data-target="#myModal">
            ...
            <li>
              <a href="#" class="bpo" title="<b><?= $this->lang->line('delete_suppliers') ?></b>"
                ...
                <i class="fa fa-trash"></i> <?= lang('delete_suppliers') ?>
              </a>
            </li>
          </ul>
        </li>
        ...
        <div class="row">
          <div class="col-sm-3 float-right">
            <div class="input-group">
              <input id="dtfilter" class="form-control dtfilter" data-name="suppliers" placeholder="<?= lang('search'); ?>">
